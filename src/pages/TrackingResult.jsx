    ...
    return (
      <div className="min-h-[80vh] bg-slate-50 py-24 px-4 flex items-center justify-center">
        ...
        <div className="text-center max-w-xl mx-auto">
          ...
          <h1 className="text-4xl font-black text-slate-900 mb-6">Track Your Package</h1>
          <p className="text-slate-500 mb-10 text-lg">Enter your tracking number below to see real-time updates and carrier detection.</p>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-12">
            ...
            <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Universal Tracking</span>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32 text-slate-400">
            ...
            <p className="font-bold uppercase tracking-widest text-xs">Connecting to Carrier Servers...</p>
          </div>
        ) : error ? (
          <div className="bg-white rounded-[2rem] p-12 text-center border border-slate-100 shadow-xl max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl font-black text-slate-900 mb-3">Oops! Shipment Not Found</h2>
            <p className="text-slate-500 mb-8">{error}</p>
            <div className="space-y-4">
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Try Again</p>
                <TrackingForm variant="small" />
            </div>
          </div>
        ) : trackingData && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="mt-12 p-8 bg-blue-900 rounded-3xl text-white relative overflow-hidden">
                <div className="relative z-10">
                    <h3 className="text-xl font-bold mb-2">Want automatic notifications?</h3>
                    <p className="text-blue-200 text-sm mb-6 max-w-md">Our mobile app provides push notifications for every status change. Never miss a delivery again.</p>
                    <button className="bg-white text-blue-900 px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-blue-50 transition-colors">
                        Download ShipTrack App
                    </button>
                </div>
